...
import com.wifishare.filesharing.datashare.smartshare.databinding.FragmentInstructionFiveBinding
import com.wifishare.filesharing.datashare.smartshare.databinding.FragmentInstructionTwoBinding


class InstructionFragmentFive : Fragment() {

    private var binding : FragmentInstructionFiveBinding? = null
    companion object {
        var imagetype = ""
    }
    ...
    override fun onCreateView(
        ...
        binding = FragmentInstructionFiveBinding.inflate(layoutInflater , container , false)

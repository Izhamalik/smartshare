...
import com.wifishare.filesharing.datashare.smartshare.adapters.HistoryApkAdapter
...
import com.wifishare.filesharing.datashare.smartshare.databinding.FragmentApkHistoryBinding
...
class ApkHistoryFragment : Fragment(), FileSelectionItem {

    private var binding: FragmentApkHistoryBinding? = null
    private var adapater: HistoryApkAdapter? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentApkHistoryBinding.inflate(layoutInflater, container, false)

        adapater = HistoryApkAdapter()
        ...
        pageViewModel.files.observe(viewLifecycleOwner) {
            ...
            if (it.isNotEmpty()) {
                ...
                adapater?.setValues(requireContext(), it, "music", this)

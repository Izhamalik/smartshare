...
//1. Create a mask animation layer
...
//2. Create Animation
        ...
        //3. Set the LayoutParams of the mask layer ImageView
...
//Set the background of the mask layer ImageView
...
// Calculate displacement
        int xOffset = endLocArray[0] - startLocArray[0] + targetViewLayoutParams.width / 2;// The X coordinate of the animation displacement
        int yOffset = endLocArray[1] - startLocArray[1] + targetViewLayoutParams.height / 2;// The y coordinate of the animation displacement
        TranslateAnimation translateAnimationX = new TranslateAnimation(0,
                xOffset, 0, 0);
        translateAnimationX.setInterpolator(new LinearInterpolator());
        translateAnimationX.setRepeatCount(0);// The number of times the animation is repeated
        translateAnimationX.setFillAfter(true);

        TranslateAnimation translateAnimationY = new TranslateAnimation(0, 0,
                0, yOffset);
        translateAnimationY.setInterpolator(new LinearInterpolator());
        translateAnimationY.setRepeatCount(0);// The number of times the animation is repeated
        translateAnimationX.setFillAfter(true);
        ...
        set.setDuration(800);// animation execution time
    ...
    /**
     * Monitoring of shopping cart animation
     */
